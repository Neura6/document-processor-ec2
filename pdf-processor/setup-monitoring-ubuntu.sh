...
echo "🚀 Starting PDF Processing Monitoring Setup for Ubuntu..."
...
if [ $USAGE -gt $THRESHOLD ]; then
    ...
    NEW_USAGE=$(df /opt/monitoring | tail -1 | awk '{print $5}' | sed 's/%//')
...
#!/bin/bash
# Start monitoring services on Ubuntu
...
#!/usr/bin/env python3
"""
System Monitoring Script for Ubuntu
